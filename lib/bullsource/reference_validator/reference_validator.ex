defmodule Bullsource.ReferenceValidator do
  ...
  defmodule Result do
    defstruct url: nil, title: nil, valid: false
  end
  ...
  def start_link(url, backend, limit) do
  ...
  defp spawn_query(backend, url, limit) do
    ...
    {:ok, pid} = Supervisor.start_child(Bullsource.ReferenceValidator.Supervisor, opts) #spawn a a child
